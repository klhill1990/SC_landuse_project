...
##analyze patterns between trawl distances and species richness/abundance 
##(ie, do longer trawls produce more individuals/higher species richness)
...
#create linear models between species richness/abundance and trawl distances (both log-trasnformed) for all stations and separated by station type
...
#plot relationships as scatter plots with lm regression line
